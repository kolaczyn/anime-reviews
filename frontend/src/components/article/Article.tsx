...
const Article: React.FC<Props> = ({
  pageContext: { title, subtitle, published_at, content, similarReviewOne, story, opening, characters, awesomeness },
}) => {
  return (
    <>
    <Helmet>
    ...
    <ContainerSmall>
      <section>
        <header className="flex justify-between">
          ...
          <span>{calculateRating(story, opening, characters, awesomeness)}%</span>
          </header>
        <span>{subtitle}</span>
        <div>{content}</div>
      </section>
